...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let rec = simplant_lab::RecordingStreamBuilder::new(
        "rerun_example_series_point_style",
    )
    .spawn()?;
    ...
    rec.log_static(
        ...
        &simplant_lab::SeriesPoints::new()
            ...
            .with_markers([simplant_lab::components::MarkerShape::Circle])
    ...
    rec.log_static(
        ...
        &simplant_lab::SeriesPoints::new()
            ...
            .with_markers([simplant_lab::components::MarkerShape::Cross])
    ...
    for t in 0..((std::f32::consts::TAU * 2.0 * 10.0) as i64) {
        ...
        rec.log(
            "trig/sin",
            &simplant_lab::Scalars::single((t as f64 / 10.0).sin()),
        )?;
        rec.log(
            "trig/cos",
            &simplant_lab::Scalars::single((t as f64 / 10.0).cos()),
        )?;
    }
