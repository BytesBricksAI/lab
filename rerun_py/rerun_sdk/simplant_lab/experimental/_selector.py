...
class Selector:
    ...
    def pipe(self, func: Callable[[pa.Array], pa.Array | None] | Selector) -> Selector:
        ...
        func:
            ...
            or `None`, or another [`Selector`][simplant_lab.experimental.Selector] to chain.

        Returns
        -------
        A new [`Selector`][simplant_lab.experimental.Selector] with the transformation applied.
