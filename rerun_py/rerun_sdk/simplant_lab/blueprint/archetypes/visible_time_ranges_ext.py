...
from simplant_lab.datatypes.visible_time_range import VisibleTimeRange
...
class VisibleTimeRangesExt:
    """Extension for [VisibleTimeRanges][simplant_lab.blueprint.archetypes.VisibleTimeRanges]."""
